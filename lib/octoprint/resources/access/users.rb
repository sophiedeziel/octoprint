  ...
  module Resources
    module Access
      ...
      class Users < BaseResource
        ...
        #   users = Octoprint::Resources::Access::Users.list
        #   users.each do |user|
        ...
        #   user = Octoprint::Resources::Access::Users.add(
        #     name: "john_doe",
        ...
        #   user = Octoprint::Resources::Access::Users.get(username: "john_doe")
        #
        ...
        #   user = Octoprint::Resources::Access::Users.update(
        #     username: "john_doe",
        #     params: {
        #       active: false,
        ...
        #   Octoprint::Resources::Access::Users.delete(username: "john_doe")
        #
        # @param username [String] The user's login name
        # @return [void]
        ...
        #   Octoprint::Resources::Access::Users.change_password(
        #     username: "john_doe",
        ...
        #   settings = Octoprint::Resources::Access::Users.get_settings(username: "john_doe")
        #
        # @param username [String] The user's login name
        ...
        #   settings = Octoprint::Resources::Access::Users.update_settings(
        #     username: "john_doe",
        ...
        #   api_key = Octoprint::Resources::Access::Users.generate_api_key(username: "john_doe")
        #
        # @param username [String] The user's login name
        ...
        #   Octoprint::Resources::Access::Users.delete_api_key(username: "john_doe")
        #
        # @param username [String] The user's login name
        # @return [void]
        sig { params(username: String).void }

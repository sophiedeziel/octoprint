...
RSpec.describe Octoprint::BaseResource do
  ...
  describe ".fetch_resource" do
    ...
    context "with default parameters" do
      it "makes a GET request to the resource path" do
        ...
        expect(mock_client).to have_received(:request).with("/api/test", http_method: :get)
      end
    ...
    context "with custom path" do
      it "appends the path to the resource path" do
        ...
        expect(mock_client).to have_received(:request).with("/api/test/custom", http_method: :get)
      end
    end
    ...
    context "with options" do
      it "builds query string from options" do
        ...
        expect(mock_client).to have_received(:request).with("/api/test?param1=value1&param2=value2", http_method: :get)
      end
    end
  ...
  describe ".post" do
    ...
    before do
      allow(mock_client).to receive(:request).and_return(true)
    end
